...
<div class="container"> 
<a href="/sd/crear-subcategoria/{{Request::segment(3)}}" class="btn btn-primary pull-right">Crear Sub Categoria</a>
<br>
<br>
<br>
</div>
                                   ...
                                   @foreach($subcategorias as $subcategorias) 
                                        <tr>
                                            ...
                                            <td class="text-center">
                                               <a href="/sd/productos/{{$subcategorias->id}}"><span id="tip" data-toggle="tooltip" data-placement="left" title="Ver Contenidos" class="btn btn-warning"><i class="fa fa-list-alt sidebar-nav-icon"></i></span></a>
