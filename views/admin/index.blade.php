...
<div class="container">
  <a href="/sd/crear-categoria" class="btn btn-primary pull-right">Crear Categoria</a>
  <br>
  <br>
  <br>
</div>
                                   ...
                                   @foreach($categories as $category) 
                                        <tr>
                                            ...
                                            <td class="text-center">
                                               <a href="/sd/subcategorias/{{$category->id}}"><span id="tip" data-toggle="tooltip" data-placement="left" title="Ver Contenidos" class="btn btn-warning"><i class="fa fa-list-alt sidebar-nav-icon"></i></span></a>
