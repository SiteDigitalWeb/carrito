                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                      {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('sd/createcategoria'))) }}
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               ...
                                               {{Form::hidden('categoriapro', Request::segment(3), array('class' => 'form-control','placeholder'=>'Ingrese titulo','required' => 'required'))}}
