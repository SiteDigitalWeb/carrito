...
<div class="container">
    <a href="/sd/crear-producto/{{Request::segment(3)}}" class="btn btn-primary pull-right">Crear Producto</a>
    <br>
    <br>
    <br>
</div>
                                     ...
                                     @foreach($productos as $producto)
                                        <tr>
                                            ...
                                            <td class="text-center" style="width:1%">
                                                {!! QrCode::size(70)->generate('https://www.conceptodigitalweb.com/') !!}
                                            </td>
...
{!! QrCode::size(430)->generate('https://www.instagram.com/armoniaycris') !!}
