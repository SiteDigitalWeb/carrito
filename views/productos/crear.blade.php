                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'GET','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/productos/crearproducto'))) }}
                                        ...
                                        {{Form::hidden('categoriapro', $categoria->cms_categoria_id, array('class' => 'form-control','placeholder'=>'Ingrese Iva'))}}
                                        @endforeach
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                           ...
                                           <input type="hidden" name="peca" value="{{Request::segment(3)}}"></input>
